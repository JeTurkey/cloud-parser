...
def main():
    ...
    mycursor.execute('SELECT gov_dept_id FROM gov_dept')
    ...
    for i in company_id:
        ...
        sql = "INSERT INTO ttd.gov_score (gov_dept_id, record_date, pos, neg, neutral, pos_rate, neg_rate) VALUES (%s, %s, %s, %s, %s, %s, %s)"
